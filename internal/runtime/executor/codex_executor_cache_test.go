...
func TestCodexExecutorCacheHelper_OpenAIChatCompletions_StablePromptCacheKeyFromAPIKey(t *testing.T) {
	...
	expectedKey := stableCodexContinuityKey("cli-proxy-api:codex:prompt-cache:test-api-key")
...
func TestCodexExecutorCacheHelper_OpenAIChatCompletions_FallsBackToStableAuthID(t *testing.T) {
	...
	expected := stableCodexContinuityKey("cli-proxy-api:codex:prompt-cache:auth:codex-auth-1")
